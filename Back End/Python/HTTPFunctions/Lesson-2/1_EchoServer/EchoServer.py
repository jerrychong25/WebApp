...
class EchoHandler(BaseHTTPRequestHandler):      # Changed here
    def do_GET(self):
        ...
        self.wfile.write(self.path[1:].encode())        # Changed here

if __name__ == '__main__':
    server_address = ('', 8000)  # Serve on all addresses, port 8000.
    httpd = HTTPServer(server_address, EchoHandler)        # Changed here
    httpd.serve_forever()
